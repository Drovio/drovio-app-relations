...
$attr = array();
$attr['pid'] = $personID;
$viewContainer = $appContent->getAppViewContainer($viewName = "details/contactInfo", $attr, $startup = FALSE, $containerID = "", $loading = FALSE, $preload = TRUE);
...
else
{
	...
	$personID = $ePerson->getDrovioPersonByMail();
	if (!empty($personID))
	{
