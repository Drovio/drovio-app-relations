...
$attr = array();
$attr['pid'] = $personID;
$viewContainer = $appContent->getAppViewContainer($viewName = "relations/contactInfo", $attr, $startup = TRUE, $containerID = "contactInfoViewContainer", $loading = FALSE, $preload = FALSE);
...
$attr = array();
$attr['pid'] = $personID;
$viewContainer = $appContent->getAppViewContainer($viewName = "relations/customInfo", $attr, $startup = TRUE, $containerID = "customInfoViewContainer", $loading = FALSE, $preload = FALSE);
DOM::append($section, $viewContainer);
