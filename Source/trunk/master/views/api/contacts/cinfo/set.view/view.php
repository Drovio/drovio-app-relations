...
$status = $ePersonInfo->set($_POST['cname'], $_POST['cvalue']);
if (!$status)
{
	// Show error
	$error = array();
...
$customInfo = $ePersonInfo->get();

// Return report
return $jsonContent->getReport($customInfo, $allowOrigin = "", $withCredentials = FALSE, $key = "cinfo");
//#section_end#
?>