...
// Check if there is a given phone id
$phoneID = engine::getVar("phid");
if (empty($phoneID))
	$response = $phoneList;
else
	$response[$phoneID] = $phoneList[$phoneID];

// Return report
return $jsonContent->getReport($response, $allowOrigin = "", $withCredentials = FALSE, $key = "phone_list");
//#section_end#
?>