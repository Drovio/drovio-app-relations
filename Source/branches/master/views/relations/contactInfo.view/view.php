...
$infoRow = getInfoRow("info", $personInfo['firstname']." ".$personInfo['lastname']);
...
{
	$infoRow = getInfoRow("birthday", $personInfo['date_of_birth']);
	DOM::append($viewContainer, $infoRow);
}
...
$attr = array();
$attr['pid'] = $personID;
$actionFactory->setAction($editButton, $viewName = "relations/editContactInfo", $holder = ".contactInfoContainer .editFormContainer", $attr, $loading = TRUE);
